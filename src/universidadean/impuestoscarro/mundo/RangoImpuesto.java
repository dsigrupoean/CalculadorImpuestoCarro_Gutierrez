...
public class RangoImpuesto {
     ...
     */
    public boolean contieneA(double pValor) {  return (pValor >= inicio && pValor < fin);
    }

    /**
     * Retorna el inicio rango.
     *
     * @return inicio del rango.
     */
    ...
    /**
     * Retorna el fin rango.
     *
     * @return fin del rango.
     */
